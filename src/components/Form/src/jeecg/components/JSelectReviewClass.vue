...
<template>
  <div>
    ...
    <ReviewClassSelectModal @register="regModal" @getSelectResult="setValue" v-bind="getBindValue" />
  </div>
</template>
<script lang="ts">
  import ReviewClassSelectModal from './modal/ReviewClassSelectModal.vue';
  ...
  export default defineComponent({
    name: 'JSelectReviewClass',
    components: {
      ReviewClassSelectModal,
      JSelectBiz,
    },
    inheritAttrs: false,
    props: {
