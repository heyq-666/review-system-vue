...
<template>
  <div>
    ...
    <ExpertBeGoodAtModal @register="regModal" @getSelectResult="setValue" v-bind="getBindValue" />
  </div>
</template>
<script lang="ts">
  import ExpertBeGoodAtModal from '/@/components/Form/src/jeecg/components/modal/ExpertBeGoodAtModal.vue';
