...
<template>
  <div>
    ...
    <JSelectReviewUserGroupModal @register="regModal" @getSelectResult="setValue" v-bind="getBindValue" />
  </div>
</template>
<script lang="ts">
  import JSelectReviewUserGroupModal from './modal/JSelectReviewUserGroupModal.vue';
  ...
  export default defineComponent({
    name: 'JSelectReviewUserGroup',
    components: {
      JSelectReviewUserGroupModal,
      JSelectBiz,
    },
    inheritAttrs: false,
    props: {
