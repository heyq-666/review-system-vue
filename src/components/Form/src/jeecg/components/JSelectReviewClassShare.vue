...
<template>
  <div>
    ...
    <ReviewClassSelectModalShare @register="regModal" @getSelectResult="setValue" v-bind="getBindValue" />
  </div>
</template>
<script lang="ts">
  import ReviewClassSelectModalShare from './modal/ReviewClassSelectModalShare.vue';
  ...
  export default defineComponent({
    name: 'JSelectReviewClassShare',
    components: {
      ReviewClassSelectModalShare,
      JSelectBiz,
    },
    inheritAttrs: false,
    props: {
