...
<script lang="ts" setup>
  ...
  import {reviewQuestionList, reviewQuestionDelete, reviewQuestionDeleteBatch, reviewQuestionExportXlsUrl, reviewQuestionImportUrl } from './ReviewClass.api';
  ...
  import {downloadFile} from '/@/utils/common/renderUtils';
    ...
    const {prefixCls, tableContext, onImportXls, onExportXls} = useListPage({
        ...
        exportConfig: {
            name: '问题列表',
            url: reviewQuestionExportXlsUrl,
            params: {
                'classId': mainId
            }
        },
